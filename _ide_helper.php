 ...
 */
     ...
     */
         ...
         *
         * This method returns-vendor the first configured path in the array of view paths.
         *
         * @param string $path
         * @return string
         * @static
        ...
        {            //Method inherited from \Illuminate\Container\Container
                    ...
                    /**
         * Finds an entry of the container by its identifier and returns-vendor it.
         *
         * @return mixed
         * @param string $id Identifier of the entry to look for.
     ...
     */
        ...
        {            //Method inherited from \Illuminate\Database\Connection
                    ...
                    /**
         * Run a select statement against the database and returns-vendor all of the result sets.
         *
         * @param string $query
         * @param array $bindings
         * @param bool $useReadPdo
        ...
        {            //Method inherited from \Illuminate\Database\Connection
                    ...
                    /**
         * Run a select statement against the database and returns-vendor a generator.
         *
         * @param string $query
         * @param array $bindings
         * @param bool $useReadPdo
     ...
     */
        ...
        public static function response($body = null, $status = 200, $headers = [])
        {
                    ...
                    /**
         * Get an invokable object that returns-vendor a sequence of responses in order for use during stubbing.
         *
     ...
     */
         ...
         *
         *  * http://localhost/mysite              returns-vendor an empty string
         *  * http://localhost/mysite/about        returns-vendor '/about'
         *  * http://localhost/mysite/enco%20ded   returns-vendor '/enco%20ded'
         *  * http://localhost/mysite/about?var=1  returns-vendor '/about'
         *
         ...
         *
         *  * http://localhost/index.php         returns-vendor an empty string
         *  * http://localhost/index.php/page    returns-vendor an empty string
         *  * http://localhost/web/index.php     returns-vendor '/web'
         *  * http://localhost/we%20b/index.php  returns-vendor '/we%20b'
         *
         * @return string The raw path (i.e. not urldecoded)
         * @static
         */
         ...
         * server might be different. This returns-vendor the former (from the "Via" header)
         * if the proxy is trusted (see "setTrustedProxies()"), otherwise it returns-vendor
         ...
         *
         * Returns true when value is "1", "true", "on", and "yes". Otherwise, returns-vendor false.
         *
         * @param string|null $key
         * @param bool $default
         * @return bool
     ...
     */
        ...
        public static function permanentRedirect($uri, $destination)
        {
                    ...
                    /**
         * Register a new route that returns-vendor a view.
         *
         * @param string $uri
         * @param string $view
         * @param array $data
...
')
     ...
     */
        ...
        {
                        /** @var \Javoscript\MacroableModels\MacroableModels $instance */
