...
@section('content')
    <div class="mt-5">
        <div class="intro-y mt-2 flex">
            ...
            <a href="{{ route('vendor.receipts.create') }}" class="mb-2 transition duration-200 border
                        ...
                        >
                            ...
                            @can('edit', $receipt)
                                <x-base.button
                                    as="a"
                                    size="sm"
                                    href="{{ route('vendor.receipts.edit', compact('receipt')) }}"
                                    type="button"
                                    variant="outline-success"
                                    data-route="{{ route('vendor.receipts.destroy', compact('receipt')) }}"
                                >
