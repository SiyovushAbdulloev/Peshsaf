...
@section('content')
    <div class="mt-5">
        <div class="intro-y my-5 flex gap-4">
            ...
            <a href="{{ route('admin.warehouses.create') }}" class="transition duration-200 border
                        ...
                        >
                            ...
                            >
                                <x-base.button
                                    as="a"
                                    size="sm"
                                    href="{{ route('admin.warehouses.edit', compact('warehouse')) }}"
                                    type="button"
                                ...
                                <x-base.button
                                    ...
                                    data-route="{{ route('admin.warehouses.destroy', compact('warehouse')) }}"
                                >
