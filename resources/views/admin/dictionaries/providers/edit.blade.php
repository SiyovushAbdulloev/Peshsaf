...
@section('subcontent')
    <div class="intro-y mt-10 flex flex-row justify-content-between">
        ...
        <form class="ml-auto" action="{{ route('admin.dictionaries.providers.destroy', compact('provider')) }}"
    ...
    <div class="mt-5">
        <div class="intro-y col-span-12 lg:col-span-6">
            <form action="{{ route('admin.dictionaries.providers.update', compact('provider')) }}" method="post">
                @csrf
                @method('PATCH')
