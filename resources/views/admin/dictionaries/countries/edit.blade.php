...
@section('subcontent')
    <div class="intro-y mt-10 flex flex-row justify-content-between">
        ...
        <form class="ml-auto" action="{{ route('dictionaries.countries.destroy', compact('country')) }}"
    ...
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 lg:col-span-6">
            <form action="{{ route('dictionaries.countries.update', compact('country')) }}" method="post">
                @csrf
                @method('PATCH')
