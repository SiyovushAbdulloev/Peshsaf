...
@section('subcontent')
    <h2 class="intro-y mt-10 text-lg font-medium">Действующие вещества</h2>
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 mt-2 flex flex-wrap items-center ml-auto">
            <a href="{{ route('admin.dictionaries.substances.create') }}" class="transition duration-200 border
            ...
            >
                ...
                @foreach($substances as $substance)
                    ...
                    >
                        ...
                        >
                            <a href="{{ route('admin.dictionaries.substances.edit', compact('substance')) }}"
                               class="mr-4">
