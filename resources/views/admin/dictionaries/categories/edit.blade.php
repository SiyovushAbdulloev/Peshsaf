...
@section('content')
    <div class="intro-y mt-10 flex flex-row justify-content-between">
        ...
        <form class="ml-auto" action="{{ route('admin.dictionaries.categories.destroy', compact('category')) }}"
    ...
    <div class="mt-5">
        <div class="intro-y col-span-12 lg:col-span-6">
            <form action="{{ route('admin.dictionaries.categories.update', compact('category')) }}" method="post">
                @csrf
                @method('PUT')
