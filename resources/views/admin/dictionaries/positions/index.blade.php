...
@section('content')
    <div class="mt-5">
        <div class="intro-y my-5 flex gap-4">
            <h2 class="intro-y text-lg font-medium">Должности</h2>
                        ...
                        >
                            ...
                            >
                                <x-base.button
                                    as="a"
                                    size="sm"
                                    href="{{ route('admin.dictionaries.positions.edit', compact('position')) }}"
                                    type="button"
                                ...
                                <x-base.button
                                    ...
                                    data-route="{{ route('admin.dictionaries.positions.destroy', compact('position')) }}"
                                >
