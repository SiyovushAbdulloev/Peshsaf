    ...
    <div class="mt-5">
        ...
        <div class="box p-4 mt-6 overflow-x-auto">
            ...
            @if($outletProducts->count())
                ...
                <div class="mt-4">
                    {{ $outletProducts->links() }}
                </div>
            @else
                <div role="alert"
                     class="mt-6 alert relative border rounded-md px-5 py-4 bg-warning border-warning bg-opacity-20 border-opacity-5 text-warning dark:border-warning dark:border-opacity-20 mb-2 flex items-center">
