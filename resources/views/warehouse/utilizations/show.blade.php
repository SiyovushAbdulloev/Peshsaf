...
@section('head')
    <title>Просмотр утилизации</title>
@endsection
            ...
            <div class="box rounded-md p-5">
                ...
                <div class="mt-3 flex items-center">
                    <x-base.icon
                        ...
                        icon="fa-user"
                    />
                    Торговая точка: <span class="ml-2">{{ $utilization->outlet->name }}</span>
                </div>
                <div class="mt-3 flex items-center">
                    <x-base.icon
                        class="mr-1 h-4 w-4 text-slate-500"
                        icon="fa-hashtag"
                    />
                    Номер: <span class="ml-2">{{ $utilization->number }}</span>
                </div>
                <div class="mt-3 flex items-center">
                    <x-base.icon
                        class="mr-1 h-4 w-4 text-slate-500"
                        icon="fa-calendar"
                    />
                    Дата: <span class="ml-2">{{ $utilization->date->format('d.m.Y') }}</span>
                </div>
            </div>
        </div>
